 ...
 */
public abstract class AuthenticationSASLResponse implements com.github.warmuuh.jedge.db.protocol.ProtocolMessage  {
	...
	public AuthenticationSASLResponse read(final JBBPBitInputStream In) throws IOException {
		data = this.readCustomFieldType(this, In, _SField1TypeParameter, _SField1FieldInfo, 0, false, -1);
		
		return this;
	}

	public AuthenticationSASLResponse write(final JBBPBitOutputStream Out) throws IOException {
