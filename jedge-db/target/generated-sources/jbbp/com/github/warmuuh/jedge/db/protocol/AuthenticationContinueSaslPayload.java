 ...
 */
public abstract class AuthenticationContinueSaslPayload implements com.github.warmuuh.jedge.db.protocol.ProtocolMessage  {
	private static final JBBPNamedFieldInfo _SField1FieldInfo = new JBBPNamedFieldInfo("data","data",0);
	...
	public AuthenticationContinueSaslPayload () {
	}

	public AuthenticationContinueSaslPayload read(final JBBPBitInputStream In) throws IOException {
		data = this.readCustomFieldType(this, In, _SField1TypeParameter, _SField1FieldInfo, 0, false, -1);
		
		return this;
	}

	public AuthenticationContinueSaslPayload write(final JBBPBitOutputStream Out) throws IOException {
		this.writeCustomFieldType(this, Out, this.data, _SField1TypeParameter, _SField1FieldInfo, 0, false, -1);
